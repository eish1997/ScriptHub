...
AssetCutter 主仓 `assetcutter-ai-pro/script-hub/` 及 `server/script-hub-api.js`（:5174 / :9101）为 2026-05 半成品，**已废弃**，不再演进。伴侣壳第五导航、`ac.script_hub.*` 已通过 **Tool Bridge integration v1** 接回；见 [24-Companion-Integration.md](./24-Companion-Integration.md)。
